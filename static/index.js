...
let _close = false;
let _fsj = false;
var url = 'https://spieny.github.io/EatXieDX/static/image/ClickBefore.png';
...
function shareText(score) {
    ...
    if (score <= 2.5 * __Time) return '拜托，你很逊欸！';
    if (score <= 5 * __Time) return '是个屑东西';
    if (score <= 7.5 * __Time) return '哎哟，很勇♂哦';
    if (score <= 10 * __Time) return '太 屑 了！';
    return '您是外星人嘛？';
}
